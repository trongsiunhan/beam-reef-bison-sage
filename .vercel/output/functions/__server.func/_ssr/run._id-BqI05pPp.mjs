...
import { l as withoutProbe, s as livePickData } from "./proxy-client-DNPLsrCj.mjs";
import { u as require_react } from "../_libs/@floating-ui/react-dom+[...].mjs";
import { P as require_jsx_runtime } from "../_libs/@radix-ui/react-alert-dialog+[...].mjs";
import { l as useOrbitStore, r as cn, s as hostPort, t as Button } from "./button-CF51ROdf.mjs";
...
import { a as browseCheckIpFn, c as browseTypeFn, d as probeUrlFn, i as Identicon, n as Route, o as browseClickFn, r as stopOrbitProfile, s as browseScrollFn, u as pickLiveProxiesFn } from "./router-f65h8p9n.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/run._id-BqI05pPp.js
	...
	const go = async (next = url) => {
		...
		try {
			...
			if (res.via === "direct" && profile.proxy && settings.autoRotateDead) {
				const live = (await pickLiveProxiesFn({ data: livePickData(settings, {
