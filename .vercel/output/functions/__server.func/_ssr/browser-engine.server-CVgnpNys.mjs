import { fetchDirect, fetchViaProxy, parseTitle, prepareHtml, probeProxy } from "./proxy-tunnel.server-vfiJcj8w.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/browser-engine.server-CVgnpNys.js
