...
import { a as fetchRandomProxy, i as fetchProxyList } from "./proxy-client-CLfqVGVh.mjs";
...
import { a as formatRelative, c as uid, l as useOrbitStore, n as buttonVariants, o as generateFingerprint, r as cn, s as hostPort, t as Button } from "./button-DozfW7tv.mjs";
...
import { i as Identicon, l as checkProxyFn, r as stopOrbitProfile, u as pickLiveProxiesFn } from "./router-B--Rj75x.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DmM_21-j.js
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: "Lấy một node ngẫu nhiên từ cụm US & EU Anycast."
									})]
...
function QuickCreateDialog({ open, onOpenChange }) {
	...
	const run = async () => {
		...
		try {
			const [livePack, list] = await Promise.all([pickLiveProxiesFn({ data: {
			...
			toast.success(liveUsed ? `Đã tạo ${n} hồ sơ · ${liveUsed} node sống, phần còn lại gán từ cụm` : `Đã tạo ${n} hồ sơ. Chưa dò được node sống từ máy chủ — cửa sổ vẫn mở trực tiếp.`);
			onOpenChange(false);
		} catch (err) {
